const EXCEPTIONS_RU = {
  ...
  podziérzgnęliśmy: "поддерьгнѧлисми",
  podziérzgnęli: "поддерьгнѧли",
  podziérzgnęłyśmy: "поддерьгнѧлысми",
  ...
  podziérzgnęlibyśmy: "поддерьгнѧлибысми",
  podziérzgnęłybyśmy: "поддерьгнѧлыбысми",
  ...
  podzygowaliśmy: "подзыговалисми",
  podzygowali: "подзыговали",
  podzygowałyśmy: "подзыговалысми",
  ...
  podzygowalibyśmy: "подзыговалибысми",
  podzygowałybyśmy: "подзыговалыбысми",
...
const EXCEPTIONS_UA = {
  ...
  podziérzgnęliśmy: "поддєрьґнѧлісмі",
  podziérzgnęli: "поддєрьґнѧлі",
  podziérzgnęłyśmy: "поддєрьґнѧлисмі",
  ...
  podziérzgnęlibyśmy: "поддєрьґнѧлібисмі",
  podziérzgnęłybyśmy: "поддєрьґнѧлибисмі",
  ...
  podzygowaliśmy: "подзиґовалісмі",
  podzygowali: "подзиґовалі",
  podzygowałyśmy: "подзиґовалисмі",
  ...
  podzygowalibyśmy: "подзиґовалібисмі",
  podzygowałybyśmy: "подзиґовалибисмі",
